...
public class ConstructionPlaceFinder {
	...
	public final TilePosition getBuildLocationNear(UnitType buildingType, TilePosition desiredPosition)
	{
		...
		// Terran_Bunker, Terran_Missile_Turret는 다른 건물 바로 옆에 붙여 짓는 경우가 많으므로 
		...
		else if (buildingType == UnitType.Terran_Bunker || buildingType == UnitType.Terran_Missile_Turret) {
